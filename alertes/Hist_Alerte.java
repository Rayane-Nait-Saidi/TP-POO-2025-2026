...
public class Hist_Alerte {
    ...
    public String display_sorted_alertes(){
        ...
        StringBuilder res = new StringBuilder("Alertes triées par gravité :\n") ;
    ...
    public String display_filtered_alertes(Zone zone , Capteur capt){
        ...
        while(it.hasNext()){
            Alerte a = it.next() ; 
            if (a.getReleve_Generale().getCapteur().getZone().equals(zone) && a.getReleve_Generale().getCapteur().equals(capt)){
                res.append(a.display_alerte()).append("\n") ;
            }
        }
